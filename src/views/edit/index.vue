  ...
  export default {
    ...
    methods: {
        edit () {
            ...
            axios.put('http://localhost:8866/ptjs/job', putData)
                .then(response => {
                // 处理成功响应
    ...
    async fetchData () {
      try {
        ...
        this.academicYear = response.data.data.academicYear,
        this.unit = response.data.data.unit,
        this.positionTitle = response.data.data.positionTitle,
        this.head = response.data.data.head,
        this.headPhone = response.data.data.headPhone,
        this.requireNumber = response.data.data.requireNumber,
        this.workingWeek = response.data.data.workingWeek,
        this.startWorkDate = response.data.data.startWorkDate,
        this.endWorkDate = response.data.data.endWorkDate,
        this.positionNature = response.data.data.positionNature,
        this.salary = response.data.data.salary,
        this.positionType = response.data.data.positionTitle,
        this.positionLevel = response.data.data.positionLevel,
        this.teacher = response.data.data.teacher,
        this.budget = response.data.data.budget,
        this.numberLastYear = response.data.data.numberLastYear,
        this.applicantMonth = response.data.data.applicantMonth,
        this.demandMonth = response.data.data.demandMonth,
        this.hireType = response.data.data.hireType,
        this.workPlace = response.data.data.workPlace,
        this.positionDuty = response.data.data.positionDuty,
        this.positionDemand = response.data.data.positionDemand,
        this.startPublicDate = response.data.data.startPublicDate,
        this.endPublicDate = response.data.data.endPublicDate,
        this.genderRestriction = response.data.data.genderRestriction,
        this.gradeRestriction = response.data.data.gradeRestriction,
        this.poorRestriction = response.data.data.poorRestriction,
        this.academyRestriction = response.data.data.academyRestriction,
        this.majorRestriction = response.data.data.majorRestriction
      } catch (error) {
